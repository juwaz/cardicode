...
b = [120, 14641, 20736, 361, 25921, 361, 20736, 361]
...
from same import comp


def rand_squared():
    a = range(randrange(3, 99))
    a = [choice(a) for i in a]
...
@pytest.mark.parametrize("a,b, result", ab_res)
def test_unit(a, b, result):
    assert comp(a, b) == result
